          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="flex gap-4">
                <button onClick={handleOrderClick} className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold px-6 py-3 rounded-full transition-colors duration-200">
                  Get my assignment
                </button>
                <button 
                  onClick={goToReviews}
                  className="border-2 border-indigo-500 text-indigo-500 hover:bg-indigo-50 font-semibold px-6 py-3 rounded-full transition-colors duration-200"
                >
